            ...
            <div className="container" style={{ paddingLeft: "20px", textAlign: "left" }}>
                <Formik initialValues={
                    ...
                    onSubmit={(values, { setSubmitting }) => {
                        ...
                        axios.post("https://hotel-booking-5b05b-default-rtdb.firebaseio.com/booking.json", values)
                            .then(response => {
                                axios.put("https://hotel-booking-5b05b-default-rtdb.firebaseio.com/hotels/"+this.props.hotel.id+".json", hotel)
